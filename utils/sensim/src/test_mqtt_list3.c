...
// PUBLISH
//--------------------------------------------
static list_pub_t list_publish_devices5738timeout_20 =
{
	/*.next =*/ 0,
...
static mqtt_publish_header_t publish_header_m1 =
{
	...
	/*.qos =*/ 1,
	/*.pub_list =*/ 0,
	/*.pub_item =*/ &list_publish_devices5738timeout_20,
};

static list_pub_t list_publish_actuators57382_1 =
{
	/*.next =*/ 0,
...
static mqtt_publish_header_t publish_header_m3 =
{
	...
	/*.qos =*/ 1,
	/*.pub_list =*/ 0,
	/*.pub_item =*/ &list_publish_actuators57382_1,
};
...
static test_t test_list[] =
{
	...
	},
	{
		...
		(void *)&publish_header_m1,             // msg_id=1, qos=1, retain=1, topic_name="devices/5738/timeout", topic_data="20"
		&mqtt_response_puback,                  // wait for PUBACK with
		(void *)&puback_header_m1,              // msg_id=1
	...
	{
		5,                                      // then after a delay of 5 sec
		&mqtt_command_publish,                  // send PUBLISH with
		(void *)&publish_header_m3,             // msg_id=3, qos=1, retain=1, topic_name="actuators/5738/2/command", topic_data="1"
		&mqtt_response_puback,                  // wait for PUBACK with
...
//--------------------------------------------
size_t test_mqtt_list3_get_size(void)
{
	return (sizeof(test_list) / sizeof(test_t));
}

//--------------------------------------------
test_t *test_mqtt_list3_get_test(size_t number)
{
